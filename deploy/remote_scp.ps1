...
$psi.Arguments = "-o StrictHostKeyChecking=no -o UserKnownHostsFile=NUL -o KexAlgorithms=ecdh-sha2-nistp256 -o PreferredAuthentications=password `"$LocalPath`" debian@192.168.1.70:`"$RemotePath`""
